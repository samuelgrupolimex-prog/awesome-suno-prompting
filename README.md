...
- [Suno Style Recipes](https://github.com/samuelgrupolimex-prog/suno-style-recipes) - 564 style recipes, each with a Suno-ready style prompt, BPM, Weirdness and Style Influence. Public domain (CC0), as CSV, JSON and Parquet.
